...
#        widget.set_icon_widget(img)
    ...
    def initabouttcos(self):
        self.main.abouttcos = self.main.ui.get_object('abouttcos')
        self.main.abouttcos.hide()
        self.main.abouttcos.set_icon_from_file(shared.IMG_DIR +'tcos-icon-32x32.png')
        
        self.main.abouttabs = self.main.ui.get_object('abouttabs')
        ...
        self.main.abouttcos_version=self.main.ui.get_object('abouttcos_version')
        self.main.abouttcos_version.set_text(shared.version)
        
        self.main.donateurllabel = self.ui.get_object('donateurllabel')
        
        self.main.abouttcos_donatebutton = self.ui.get_object('abouttcos_donatebutton')
        self.main.abouttcos_donatebutton.connect('clicked', self.main.actions.on_donateurl_click)
        
        # LOAD LICENSE_FILE in TextView
        self.main.abouttcos_license = self.ui.get_object('abouttcos_license')
        ...
        self.main.abouttcos_logo = self.ui.get_object('abouttcos_logo')
        self.main.abouttcos_logo.set_from_file(shared.IMG_DIR +'tcos-logo.png')
        
        self.main.abouttcos_webbutton = self.ui.get_object('abouttcos_webbutton')
        self.main.abouttcos_webbutton.connect('clicked', self.main.actions.on_weburl_click)
        
        self.main.abouttcos_donatecheck = self.ui.get_object('abouttcos_donatecheck')
...
#        
#        self.main.ask = self.main.ui.get_object('askwindow')
...
#        
#        
#        self.main.ask_label = self.main.ui.get_object('txt_asklabel')
#        ## arrastrar y soltar
#        self.main.ask_fixed = self.main.ui.get_object('ask_fixed')
#        self.main.ask_dragdrop = self.main.ui.get_object('label99')
#        self.main.image_entry = self.main.ui.get_object('image_askentry')
...
#            
#        self.main.ask_entry = self.main.ui.get_object('txt_askentry')
...
#        
#        self.main.ask_cancel = self.main.ui.get_object('ask_cancelbutton')
#        self.main.ask_exec = self.main.ui.get_object('ask_exebutton')
#        
#        # buttons signals
