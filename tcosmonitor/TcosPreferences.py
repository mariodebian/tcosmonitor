...
class TcosPreferences:
    ...
    def __init__(self, main):
        ...
        self.main.pref = self.main.ui.get_object('prefwindow')            
        self.main.pref.hide()
        ...
        # make pref widgets
        self.main.pref_spin_update = self.main.ui.get_object('spin_update')
        self.main.pref_cache_timeout = self.main.ui.get_object('spin_cache_timeout')
        self.main.pref_actions_timeout = self.main.ui.get_object('spin_actions_timeout')
        self.main.pref_scrotsize = self.main.ui.get_object('spin_scrotsize')
        self.main.pref_miniscrotsize = self.main.ui.get_object('spin_miniscrotsize')
        self.main.pref_xmlrpc_username = self.main.ui.get_object('xmlrpc_username')
        self.main.pref_xmlrpc_password = self.main.ui.get_object('xmlrpc_password')
        
        self.main.pref_ssh_remote_username = self.main.ui.get_object('ssh_remote_username')
        self.main.pref_ports_tnc = self.main.ui.get_object('ports_net_controller')
        self.main.pref_vlc_method_send = self.main.ui.get_object('vlc_method_send')
        self.populate_select(self.main.pref_vlc_method_send, shared.vlc_methods_send )
        
        # populate selects (only on startup)
        self.main.combo_network_interfaces = self.main.ui.get_object('combo_networkinterface') 
        self.populate_select(self.main.combo_network_interfaces, self.main.common.GetAllNetworkInterfaces() )
        
        # scan method
        self.main.pref_combo_scan_method = self.main.ui.get_object('combo_scanmethod')
        self.populate_select(self.main.pref_combo_scan_method, shared.scan_methods )
        
        # static host list button
        self.main.pref_open_static = self.main.ui.get_object('button_open_static')
        ...
        # listmode method
        self.main.pref_combo_listmode = self.main.ui.get_object('combo_listmode')
        self.populate_select(self.main.pref_combo_listmode, shared.list_modes )
        
        
        # checkboxes
        self.main.pref_populatelistatstartup = self.main.ui.get_object('ck_showliststartup')
        #self.main.pref_cybermode = self.main.ui.get_object('ck_cybermode')
        self.main.pref_systemprocess = self.main.ui.get_object('ck_systemprocess')
        self.main.pref_threadscontrol = self.main.ui.get_object('ck_threadscontrol')
        self.main.pref_enable_sslxmlrpc = self.main.ui.get_object('ck_enable_sslxmlrpc')
        self.main.pref_blockactioninthishost = self.main.ui.get_object('ck_blockactioninthishost')
        self.main.pref_onlyshowtcos = self.main.ui.get_object('ck_onlyshowtcos')
        self.main.pref_selectedhosts = self.main.ui.get_object('ck_selectedhosts')
        
        self.main.pref_tcosinfo = self.main.ui.get_object('ck_tcosinfo')
        self.main.pref_cpuinfo = self.main.ui.get_object('ck_cpuinfo')
        self.main.pref_kernelmodulesinfo = self.main.ui.get_object('ck_kernelmodulesinfo')
        self.main.pref_pcibusinfo = self.main.ui.get_object('ck_pcibusinfo')
        self.main.pref_ramswapinfo = self.main.ui.get_object('ck_ramswapinfo')
        self.main.pref_processinfo = self.main.ui.get_object('ck_processinfo')
        self.main.pref_networkinfo = self.main.ui.get_object('ck_networkinfo')
        self.main.pref_xorginfo = self.main.ui.get_object('ck_xorginfo')
        self.main.pref_soundserverinfo = self.main.ui.get_object('ck_soundserverinfo')
        
        self.main.pref_menugroups = self.main.ui.get_object('ck_menugroups')
        
        # menus show hide
        for menu in shared.preferences_menus:
            setattr(self.main, "pref_" + menu, self.main.ui.get_object(menu) )
